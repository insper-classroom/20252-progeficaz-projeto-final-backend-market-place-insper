...
class Linting(IntEnum):
    ...
    this feature currently includes support for flagging cartesian items
    in SQL statements.
    ...
    COLLECT_CARTESIAN_items = 1
    """Collect data on FROMs and cartesian items and gather into
    'self.from_linter'"""

    WARN_LINTING = 2
    "Emit warnings for linters that find problems"

    FROM_LINTING = COLLECT_CARTESIAN_items | WARN_LINTING
    """Warn for cartesian items; combines COLLECT_CARTESIAN_items
    and WARN_LINTING"""


NO_LINTING, COLLECT_CARTESIAN_items, WARN_LINTING, FROM_LINTING = tuple(
    Linting
)
...
class SQLCompiler(Compiled):
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    def _compose_select_body(
        ...
        if self.linting & COLLECT_CARTESIAN_items:
